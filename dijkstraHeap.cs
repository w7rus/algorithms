    namespace DijkstraHeap
    {
        internal class Program
        {
            ...
            {
                var dijkstra = new DijkstraHeap<int>(new Dictionary<int, Dictionary<int, ulong>>
                {
                    {
        ...
        public class DijkstraHeap<TNodeKey>
            where TNodeKey : IEquatable<TNodeKey>
        {
            ...
            public DijkstraHeap(Dictionary<TNodeKey, Dictionary<TNodeKey, ulong>> map)
            {
                _map = map;
